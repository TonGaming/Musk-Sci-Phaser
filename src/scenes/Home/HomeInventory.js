...
import { CloseBtnInventory } from "../Home/HomeBottomBar.js";
...
function card_item(scene, i, item) {
  ...
  const item_text_equip = scene.add
    .text(32 - 421 / 2, -120 + 506 / 2, "Equip", {
      fontFamily: "RussoOne",
      fontSize: "24px",
      color: "#1EFF00",
      align: "left",
    ...
    .setOrigin(0, 0);
  container_card.add(item_text_equip);

  // const item_text_equip_none = scene.add
  //   .text(32 - 421 / 2, -120 + 506 / 2, "None", {
  //     fontFamily: "RussoOne",
  //     fontSize: "24px",
  //     color: "#BFBFBF",
  //     align: "left",
  ...
  //   })
  //   .setOrigin(0, 0);
  // container_card.add(item_text_equip_none);
